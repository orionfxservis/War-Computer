          ...
          {!isCollapsed && (
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/80 text-xs font-bold text-slate-200 flex items-center gap-2 cursor-pointer transition-all shadow-sm"
              >
                {copiedLink ? (
                  <>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-3 py-2 rounded-xl bg-red-600/20 hover:bg-red-600/30 border border-red-500/40 text-red-400 text-xs font-bold flex items-center gap-1.5 transition-colors shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-3 py-2 rounded-xl bg-pink-600/20 hover:bg-pink-600/30 border border-pink-500/40 text-pink-400 text-xs font-bold flex items-center gap-1.5 transition-colors shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-3 py-2 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/30 border border-indigo-500/40 text-indigo-400 text-xs font-bold flex items-center gap-1.5 transition-colors shadow-sm"
              >
          ...
          {SOCIAL_FEEDS.map((feed) => {
            ...
            return (
              <div key={feed.id} className="group relative flex flex-col">
                ...
                <div className="relative z-10 flex-1 bg-slate-900 rounded-2xl border border-slate-800/90 group-hover:border-orange-500/60 overflow-hidden shadow-lg group-hover:shadow-[0_0_25px_rgba(249,115,22,0.2)] transition-all duration-300 flex flex-col">
                  {/* Media banner */}
                  <div className="relative aspect-video w-full overflow-hidden bg-slate-950">
                    ...
                    {/* Channel Tag */}
                    <div className="absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-950 border border-slate-700/80 text-white text-[11px] font-semibold">
