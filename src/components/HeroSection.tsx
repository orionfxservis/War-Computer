...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="hero-main-section" className="relative overflow-hidden z-10 border-b border-slate-800/80 pt-8 sm:pt-12 pb-12">
      {/* Ambient background glow matching orange WAR COMPUTERS branding (Zero heavy GPU filter blur) */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_40%_at_50%_0%,rgba(249,115,22,0.18),transparent)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-orange-500/40 text-orange-400 text-xs font-semibold shadow-lg shadow-orange-500/10">
            ...
            <>
              ...
              <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2">
                ...
                <button
                  ...
                  className="px-6 sm:px-8 py-4 bg-slate-900 hover:bg-slate-800 border-2 border-orange-500/60 hover:border-orange-400 text-white rounded-xl font-bold text-base sm:text-lg shadow-xl shadow-black/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2.5 cursor-pointer"
                >
              ...
              >
                {/* 1. Tested Products */}
                <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-200 bg-slate-900 py-2.5 px-3 rounded-xl border border-emerald-500/20 shadow-sm">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <span>✓ Tested Products</span>
                </div>

                {/* 2. Competitive Prices */}
                <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-200 bg-slate-900 py-2.5 px-3 rounded-xl border border-orange-500/20 shadow-sm">
                  <Tag className="w-4 h-4 text-orange-400 flex-shrink-0" />
                  <span>✓ Competitive Prices</span>
                </div>

                {/* 3. Warranty Support */}
                <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-200 bg-slate-900 py-2.5 px-3 rounded-xl border border-amber-500/20 shadow-sm">
                  <ShieldCheck className="w-4 h-4 text-amber-400 flex-shrink-0" />
                  <span>✓ Warranty Support</span>
                </div>

                {/* 4. Nationwide Delivery */}
                <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-200 bg-slate-900 py-2.5 px-3 rounded-xl border border-cyan-500/20 shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-6">
              {[
                ...
                <button
                  ...
                  className="p-3.5 rounded-2xl bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-orange-500/60 transition-all text-left group cursor-pointer shadow-sm hover:shadow-[0_0_20px_rgba(249,115,22,0.15)]"
                >
                  <div className="mb-2 p-2 rounded-xl bg-slate-950 w-fit group-hover:scale-110 transition-transform border border-slate-800">
                    {cat.icon}
                  </div>
